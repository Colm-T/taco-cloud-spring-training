package com.example.tacocloudspringtraining.Util;

import com.example.tacocloudspringtraining.Model.Ingredient;
import com.example.tacocloudspringtraining.Model.Ingredient.Type;
...
public class IngredientByIdConverter implements Converter<String, Ingredient> {
    ...
    public IngredientByIdConverter() {
        ...
        ingredientMap.put("TMTO", new Ingredient("TMTO", "Diced Tomatoes", Type.VEGETABLE));
        ingredientMap.put("LETC", new Ingredient("LETC", "Lettuce", Type.VEGETABLE));
